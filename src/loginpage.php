...
<html>
    ...
    <body>     
      ...
      <center> 
          ...
          <form action="../src/php/userLoginValidate.php" method="post">


            <div class="adtextbox adloinbox">
              <label for="uname" ><b>Email</b></label><br><br>
              <input type="text" placeholder="Enter Username" name="userEmail" id="adusername" style="width: 470px;height:40px;" required><br><br>
          
              <label for="psw"><b>Password</b></label><br><br>
              <input type="password" placeholder="Enter Password" name="userPass" id="adpassword" style="width: 470px;height:40px;"required><br><br>

              <div class="adpwcheckbox">
                <input type="checkbox" onclick="adShowPassword()">Show Password
              </div> 
                  
              <button class="adlgbtn1" type="submit" onclick="validateLogin()">Login</button> <br><br>
              <button class="adlgbtn1" type="submit" onclick="createAnAccountPage()">Sign up</button>
          ...
          <br><br>
                 ...
                 <a href="https://www.facebook.com/" class = "adfblogo"><img src="../src/Images/IMG_FBICON.png" alt="fblogo" width="230" height="33" ></a>
                 <a href="https://mail.google.com/" class = "adgooglelogo"><img src="../src/Images/lMG_GOOGLE.png" alt="googlelogo" width="230" height="33" ></a> <br><br><br>
          ...
          <div class="adfopw">
               <center>
                 <a href="../src/Fogotpassword.html">FORGOT PASSWORD ?</a><br> <br><br>
               </center>
          </div>
    </center> 
 
    <script>
      // Create an account open js
      function createAnAccountPage() {
       window.open("../src/createaccount.html");
      }
    </script>
